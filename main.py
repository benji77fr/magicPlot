...
class MainWindow(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        actionOpen = QtWidgets.QAction(QtGui.QIcon("./ressource/icons/folder-open-table.png"),
                                   "&File", self)
        actionOpen.setShortcut('Ctrl+O')
        actionOpen.setStatusTip("Open one or multiple files")
        actionOpen.triggered.connect(self.open_files)

        actionSaveMax = QtWidgets.QAction(QtGui.QIcon("./ressource/icons/disk-black.png"), "Save Max", self)
    ...
    def save_max(self):
        ...
        fileName, _ = QtWidgets.QFileDialog.getSaveFileName(self,
                                                  ...
                                                  "CSV Files (*.csv)")
        self.max_df.to_csv(fileName, index=False, header=True)
    ...
    def find_max(self):
        ...
        self.graph.plot_item.plot(data_x, data_y, pen='b')
